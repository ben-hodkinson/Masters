...
set( CTEST_SOURCE_DIRECTORY /home/mleigh/workdir/First_Stage/source )
set( CTEST_BINARY_DIRECTORY /home/mleigh/workdir/First_Stage/build )
...
set( CTEST_SITE hep01.phy.uct.ac.za )

# Start a nightly build:
message( "Starting nightly build for project WorkDir..." )
ctest_start( Nightly )
...
find_file( _buildExtractor NAMES extractCTestBuild.py
   PATH_SUFFIXES scripts PATHS /cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysis/21.2.31/InstallArea/x86_64-slc6-gcc62-opt/cmake/modules;/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysisExternals/21.2.31/InstallArea/x86_64-slc6-gcc62-opt/cmake/modules )
...
set( _subprojects AnalysisCamEvent;MyPackage;AthenaBaseComps;StoreGate;AthContainers;IOVDbDataModel;GaudiKernel;AthAnalysisBaseComps;AsgTools;xAODCore;xAODEgamma;xAODEventInfo;xAODJet;xAODMissingET;xAODTrigMissingET;xAODMuon;xAODTau;xAODTracking;xAODTruth;xAODMetaData;AssociationUtils;PATInterfaces;PMGAnalysisInterfaces;MCTruthClassifier;JetJvtEfficiency;JetSubStructureUtils;TrigDecisionTool;Asg_Test;xAODRootAccess;GoodRunsLists;EventPrimitives;FourMomUtils;xAODBTagging;xAODBase;xAODCaloEvent;xAODCutFlow;xAODPrimitives;IsolationSelection;PileupReweighting;IsolationCorrections;EgammaAnalysisHelpers;EgammaAnalysisInterfaces;AsgAnalysisInterfaces;FTagAnalysisInterfaces;MuonAnalysisInterfaces;TriggerAnalysisInterfaces;JetSelectorTools;TauAnalysisTools;JetCPInterfaces;JetCalibTools;JetInterface;JetResolution;JetUncertainties;JetMomentTools;METInterface;METUtilities;tauRecTools;PathResolver;TriggerMatchingTool;TrigConfInterfaces;TrigConfxAOD;POOLRootAccess;AthenaKernel;SUSYTools )
