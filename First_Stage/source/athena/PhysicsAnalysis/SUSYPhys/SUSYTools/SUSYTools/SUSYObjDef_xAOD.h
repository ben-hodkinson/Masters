...
namespace ST {
  ...
  class SUSYObjDef_xAOD : public virtual ISUSYObjDef_xAODTool,
    ...
    // MATT
    StatusCode GetMET_Loose(xAOD::MissingETContainer& met,
                      const xAOD::JetContainer* jet,
                      const xAOD::ElectronContainer* elec = 0,
                      const xAOD::MuonContainer* muon = 0,
                      const xAOD::PhotonContainer* gamma = 0,
    ...
    // MATT
    StatusCode GetMET_fjvt(xAOD::MissingETContainer& met,
                      const xAOD::JetContainer* jet,
                      const xAOD::ElectronContainer* elec = 0,
                      const xAOD::MuonContainer* muon = 0,
                      const xAOD::PhotonContainer* gamma = 0,
    ...
    // MATT
    double GetTotalEleTriggerSF(const xAOD::ElectronContainer& electrons, const std::string& trigExpr) override final;
  ...
  protected:
    ...
    asg::AnaToolHandle<IMETMaker> m_metMaker_loose; //MATT
    asg::AnaToolHandle<IMETMaker> m_metMaker_fjvt; //MATT
