...
namespace ST {
  ...
  class ISUSYObjDef_xAODTool : public virtual asg::IAsgTool {
    ...
    // MATT
    virtual StatusCode GetMET_Loose(xAOD::MissingETContainer& met,
  		      const xAOD::JetContainer* jet,
  		      const xAOD::ElectronContainer* elec = 0,
  		      const xAOD::MuonContainer* muon = 0,
  		      const xAOD::PhotonContainer* gamma = 0,
    ...
    // MATT
    virtual StatusCode GetMET_fjvt(xAOD::MissingETContainer& met,
  		      const xAOD::JetContainer* jet,
  		      const xAOD::ElectronContainer* elec = 0,
  		      const xAOD::MuonContainer* muon = 0,
  		      const xAOD::PhotonContainer* gamma = 0,
    ...
    // MATT
    virtual double GetTotalEleTriggerSF(const xAOD::ElectronContainer& electrons, const std::string& trigExpr) = 0;
