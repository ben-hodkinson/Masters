...
StatusCode SUSYObjDef_xAOD::GetMETSig(xAOD::MissingETContainer &met,
  ...
  ATH_CHECK( this->GetMET( met, jet, elec, muon, gamma, taujet, doTST, doJVTCut, invis ) );
...
// MATT: NEW FUNCTION FOR LOOSE SELECTION
StatusCode SUSYObjDef_xAOD::GetMET_Loose(xAOD::MissingETContainer &met,
                                   const xAOD::JetContainer* jet,
                                   const xAOD::ElectronContainer* elec,
                                   const xAOD::MuonContainer* muon,
                                   const xAOD::PhotonContainer* gamma,
  ...
  // allow creation of proxy MET by flagging objects for "neutrino/ification" as already selected
  if (invis) {
    ATH_CHECK( m_metMaker_loose->markInvisible(invis, metMap, &met) );
  }
  ...
  if (elec) {
    ...
    ATH_CHECK( m_metMaker_loose->rebuildMET(m_eleTerm, xAOD::Type::Electron, &met, metelectron.asDataVector(), metMap) );
  }
  ...
  if (gamma) {
    ...
    ATH_CHECK( m_metMaker_loose->rebuildMET(m_gammaTerm, xAOD::Type::Photon, &met, metgamma.asDataVector(), metMap) );
  }
  ...
  if (taujet) {
    ...
    ATH_CHECK( m_metMaker_loose->rebuildMET(m_tauTerm, xAOD::Type::Tau, &met, mettau.asDataVector(), metMap) );
  }
  ...
  if (muon) {
    ...
    ATH_CHECK( m_metMaker_loose->rebuildMET(m_muonTerm, xAOD::Type::Muon, &met, metmuon.asDataVector(), metMap) );
  }
  ...
  ATH_MSG_VERBOSE("Build jet/soft MET");
  ATH_CHECK( m_metMaker_loose->rebuildJetMET(m_jetTerm, softTerm, &met, jet, metcore, metMap, doJVTCut) );
  ...
  ATH_MSG_VERBOSE("Build MET sum");
  ATH_CHECK( m_metMaker_loose->buildMETSum(m_outMETTerm, &met, met[softTerm]->source()) );
  ATH_MSG_VERBOSE( "Done rebuilding MET." );
...
// MATT: NEW FUNCTION FOR fjvt SELECTION
StatusCode SUSYObjDef_xAOD::GetMET_fjvt(xAOD::MissingETContainer &met,
                                   const xAOD::JetContainer* jet,
                                   const xAOD::ElectronContainer* elec,
                                   const xAOD::MuonContainer* muon,
                                   const xAOD::PhotonContainer* gamma,
  ...
  // allow creation of proxy MET by flagging objects for "neutrino/ification" as already selected
  if (invis) {
    ATH_CHECK( m_metMaker_fjvt->markInvisible(invis, metMap, &met) );
  }
  ...
  if (elec) {
    ...
    ATH_CHECK( m_metMaker_fjvt->rebuildMET(m_eleTerm, xAOD::Type::Electron, &met, metelectron.asDataVector(), metMap) );
  }
  ...
  if (gamma) {
    ...
    ATH_CHECK( m_metMaker_fjvt->rebuildMET(m_gammaTerm, xAOD::Type::Photon, &met, metgamma.asDataVector(), metMap) );
  }
  ...
  if (taujet) {
    ...
    ATH_CHECK( m_metMaker_fjvt->rebuildMET(m_tauTerm, xAOD::Type::Tau, &met, mettau.asDataVector(), metMap) );
  }
  ...
  if (muon) {
    ...
    ATH_CHECK( m_metMaker_fjvt->rebuildMET(m_muonTerm, xAOD::Type::Muon, &met, metmuon.asDataVector(), metMap) );
  }
  ...
  ATH_MSG_VERBOSE("Build jet/soft MET");
  ATH_CHECK( m_metMaker_fjvt->rebuildJetMET(m_jetTerm, softTerm, &met, jet, metcore, metMap, doJVTCut) );
  ...
  ATH_MSG_VERBOSE("Build MET sum");
  ATH_CHECK( m_metMaker_fjvt->buildMETSum(m_outMETTerm, &met, met[softTerm]->source()) );
  ATH_MSG_VERBOSE( "Done rebuilding MET." );
